...
vim.cmd [[ set nofoldenable ]] -- Disable folding on startup
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    event = 'VeryLazy', -- From the default config
    opts = {
      -- Idk for now...
    },
    keys = {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<C-r>', builtin.lsp_document_symbols, { desc = '[S]earch Document Symbols' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>sws', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[S]earch workspace [S]ymbols')
      ...
      vim.list_extend(ensure_installed, {
        ...
        'copilot-language-server', -- Used by copilot-lsp (copilot_ls)
      })
      require('mason-tool-installer').setup { ensure_installed = ensure_installed }

      require('mason-lspconfig').setup {
        -- Don't auto-enable nvim-lspconfig's `copilot` server for the
        -- `copilot-language-server` package: copilot-lsp already enables
        -- its own `copilot_ls` config using the same binary.
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      -- Install required parsers (new nvim-treesitter doesn't have ensure_installed)
      local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'python', 'latex' }
